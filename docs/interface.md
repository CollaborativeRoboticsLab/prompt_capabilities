...
| Parameter Name    | Type   | Description |
| ---               | ---    | ---         |
| info              | string | The prompt text to send to the LLM for generating a speakable response. |
| uuid              | string | The uuid used to keep track of the prompts and their responses. |
...
| Parameter Name    | Type   | Description |
| ---               | ---    | ---         |
| text              | string | The response generated by the LLM, exposed for downstream speech synthesis runners. |
